...
public class IntroPane extends BorderPane {
    ...
    public IntroPane(Stage primaryStage, GameJourney journey, String playerName) {
        ...
        String introText = "Howdy, " + playerName + "... " +
                ...
                "Events may occur, and you must use your supplies wisely to survive. Reach the tenth town after fifty days. Safe travels, partner...\n";

        Label introLabel = new Label(introText);
        introLabel.setStyle("-fx-text-fill: limegreen; -fx-font-size: 35px; -fx-font-family: 'Quintessential'");
